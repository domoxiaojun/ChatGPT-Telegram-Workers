...
| CALLBACK_MENU                | 回调菜单              | `[]` (array string)                             | 回调菜单， 可选值 `AI_CHAT_PROVIDER`, 'AI_IMAGE_PROVIDER', 'USE_TOOLS', 'USE_OAILIKE_RELAY_TOOLS', 'CHAT_MODEL', 'IMAGE_MODEL', 'VISION_MODEL', 'TOOL_MODEL', 'ENVS', 'RERANK_AGENT', 'TEXT_HANDLE_TYPE', 'TEXT_OUTPUT', 'AUDIO_HANDLE_TYPE', 'AUDIO_OUTPUT', 'AUDIO_CONTAINS_TEXT', 'MCP' |
...
| SHOW_PARTS                | 显示信息部分           | `['model', 'model_time', 'token', 'tool', 'tool_time']`                                                                                                                                                                                                                                                                                                                                                                                                                                                 | 显示信息部分                                                                                                                                                                                                                                                                                                            |
| USE_TOOLS                 | 使用工具               | `[]`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | 使用工具                                                                                                                                                                                                                                                                                                                |
