...
import { adminDashboard, apiEnvVars, apiLogs, apiStats, apiUpdateUserConfig, apiUserConfigs, apiDeleteUserConfigKey } from './admin';
...
export function createRouter(): Router {
    ...
    router.post('/api/user-config/delete', apiDeleteUserConfigKey);
